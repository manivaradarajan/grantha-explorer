...
class TestCitationContext(unittest.TestCase):
    """Deriving the citing edition's school namespace from its frontmatter."""
    ...
    def test_kena_sankara_vakya_edition_still_sankara(self) -> None:
        """The kena-sankara-vakya edition's frontmatter declares sankara."""
        fm = {
            "grantha_id": "kena-upanishad",
            "part_num": 1,
            "commentaries_metadata": [
                {
                    "commentary_id": "sankara-vakya-bhashya",
                    "commentary_title": "वाक्यभाष्यम्",
                    "commentator": {"devanagari": "शङ्करः"},
                    "citation_namespace": "sankara",
                }
            ],
        }
        self.assertEqual(_citation_context(fm), "sankara")
